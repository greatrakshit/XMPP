 ...
 * @author Trinity
 */
public class OpenFireClient extends javax.swing.JFrame {
    ...
    private static OpenFireClient XMPP;
    ...
    public void login(String username, String password){
        ...
        for(RosterEntry re : rosterEntries){
            ...
            Logger.getLogger(OpenFireClient.class.getName()).log(Level.SEVERE, null, ex);
            buttonLogin.setText("Failed to log in. Check credentials.");
            try {
                connection.disconnect();
            } catch (SmackException.NotConnectedException ex1) {
                Logger.getLogger(OpenFireClient.class.getName()).log(Level.SEVERE, null, ex1);
            }
        } 
    }
    ...
    private void buttonSendMessageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSendMessageActionPerformed
        ...
        if(connection.isAuthenticated()){
            chat = chatManager.createChat(textToUser.getText().toString().trim()+"@"+DOMAIN.replace(".com", "").trim(), messageListener);
            try {
    ...
    public static void main(String args[]) throws SmackException, IOException, XMPPException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpenFireClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
